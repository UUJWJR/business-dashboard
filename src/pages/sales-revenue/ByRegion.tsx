          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-700">
                ...
                <th className="text-right py-2 px-3 text-gray-500 dark:text-gray-400 font-medium">实际收入（亿）</th>
                <th className="text-right py-2 px-3 text-gray-500 dark:text-gray-400 font-medium">目标（亿）</th>
