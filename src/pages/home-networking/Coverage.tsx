          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-700">
                ...
                <th className="text-right py-1 px-2 text-gray-500 dark:text-gray-400 font-medium">实际覆盖（%）</th>
                <th className="text-right py-1 px-2 text-gray-500 dark:text-gray-400 font-medium">目标（%）</th>
