          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-700">
                ...
                <th className="text-left py-2 px-3 text-gray-500 dark:text-gray-400 font-medium">产品名称</th>
                <th className="text-right py-2 px-3 text-gray-500 dark:text-gray-400 font-medium">销量</th>
              </tr>
            </thead>
            <tbody>
              {data.topProducts.map((product, index) => (
                <tr key={product.name} className="border-b border-gray-50 dark:border-gray-800">
                  ...
                  <td className="py-2 px-3 text-right text-gray-900 dark:text-white">{product.sales.toLocaleString()}</td>
                </tr>
              ))}
            </tbody>
          </table>
