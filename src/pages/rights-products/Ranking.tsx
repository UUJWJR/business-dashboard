          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-700">
                ...
                <th className="text-left py-1 px-2 text-gray-500 dark:text-gray-400 font-medium">权益名称</th>
                <th className="text-right py-1 px-2 text-gray-500 dark:text-gray-400 font-medium">活跃用户</th>
              </tr>
            </thead>
            <tbody>
              {data.topRights.map((right, index) => (
                <tr key={right.name} className="border-b border-gray-50 dark:border-gray-800">
                  ...
                  <td className="py-1 px-2 text-gray-900 dark:text-white">{right.name}</td>
                  <td className="py-1 px-2 text-right text-gray-900 dark:text-white">{right.activeUsers.toLocaleString()}</td>
                </tr>
              ))}
            </tbody>
          </table>
